...
//---------------------- RUTAS: -----------------------------
router.post("/deleteUser", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (passwordFromReq != process.env.ADMIN_PASSWORD) {
        return res
          .status(403)
          .send(`La password de administrador no es válida`);
      }
...
router.post("/cleanPostsOfUserId", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      console.log(
        `Error en la ruta /admin/cleanPostsOfUserId. ${error.message}`
      );
      return res.status(404).send(error.message);
    }
  })
);
router.post("/cleanReviewsToUser", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/deletePetsWithNoUserId", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      console.log(
        `Cantidad de pets encontradas: ${
          allThePetsWithNoUser === null || allThePetsWithNoUser === void 0
            ? void 0
            : allThePetsWithNoUser.length
        }`
      );
...
router.post("/deletePet", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const pet = yield index_1.default.Animal.findOne({
        where: { id: petID },
      });
      if (pet) {
        yield pet.destroy();
...
router.get("/createMultiplier", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/changeMultiplier", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/mutateActiveToActivo", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      for (const trans of allActiveTransactions) {
        ...
        numberModified++;
        console.log(
          `Transacciones modificadas de "active" a ${transactionTypes_1.transactionStatus.Active}: ${numberModified}`
        );
      }
      return res
        .status(200)
        .send({ transactionsModified: `${numberModified}` });
    } catch (error) {
