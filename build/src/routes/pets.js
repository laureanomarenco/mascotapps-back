...
function getPetById(id) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      console.log(
        `${
          petFoundById === null || petFoundById === void 0
            ? void 0
            : petFoundById.name
        }`
      );
...
//POST A PET:
router.post("/postNewPet", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    try {
      ...
      console.log(
        `req.auth.sub de la request = '${
          (_b = req.auth) === null || _b === void 0 ? void 0 : _b.sub
        }'`
      );
...
router.put("/update", jwtMiddleware_1.default, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d, _e;
    ...
    try {
      ...
      console.log(
        `req.body.pet.image = ${
          (_e = (_d = req.body) === null || _d === void 0 ? void 0 : _d.pet) ===
            null || _e === void 0
            ? void 0
            : _e.image
        }`
      );
      let validatedPetFromReq = (0, AnimalValidators_1.validateUpdatedPet)(
        req.body.pet
      );
...
router.get("/numberOfPetsInDB", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.get("/successAdoptions", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    console.log(`Entré al GET pets/successAdoptions`);
    try {
      const pets = yield index_1.default.Animal.findAll({
        where: { withNewOwner: "true" },
      });
      res.send(pets);
    } catch (error) {
      console.log(
...
router.get("/successFound", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/desubscribe", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.body;
      const usuario = yield index_1.default.User.update(
        { endpoints: null },
        { where: { id: id } }
      );
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      console.log("soy allUser", allUsers),
        ...
        endpointsArray.map((s) =>
          web_push_1.default.sendNotification(s, string)
        );
      res.status(200).json();
    } catch (error) {
      console.log(error);
...
router.get("/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _e;
    console.log(
      `Entré al GET pets/:id con params.id = ${
        (_e = req === null || req === void 0 ? void 0 : req.params) === null ||
        _e === void 0
          ? void 0
          : _e.id
      }`
