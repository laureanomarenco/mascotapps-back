...
const getAllReviewsRecived = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const allTransactions = yield index_1.default.Transaction.findAll({
        where: {
          [sequelize_1.Op.or]: [
            { user_offering_id: userId },
            { user_demanding_id: userId },
          ],
        },
      });
...
function getSomeUserInfo(userId) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      console.log(
        `Error en la función auxiliar someUserInfo: ${error.message}`
      );
...
function getPostsOfUser(id) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      console.log(
        `${
          postsOfUser === null || postsOfUser === void 0
            ? void 0
            : postsOfUser.length
        } posts encontrados`
      );
...
function parseReviewsToOwner(arrayOfReviews) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      let parsedReviews = yield Promise.all(
        arrayOfReviews.map((review) =>
          __awaiter(this, void 0, void 0, function* () {
            // console.log("review:");
            // console.log(review);
            let reviewer = yield index_1.default.User.findByPk(
              review.reviewer_id
            );
            ...
            return {
              ...
              reviewer_name: parseReviewerName(
                reviewer === null || reviewer === void 0
                  ? void 0
                  : reviewer.name
              ),
              reviewer_image: parseReviewerImage(
                reviewer === null || reviewer === void 0
                  ? void 0
                  : reviewer.image
              ),
...
router.get("/numberOfUsersInDB", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.get("/contactinfo/:petid", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      let ownerID =
        petInDB === null || petInDB === void 0 ? void 0 : petInDB.UserId;
...
router.get("/getallpetsofuser", jwtCheck, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
      ...
      if (
        (petsPostedByUser === null || petsPostedByUser === void 0
          ? void 0
          : petsPostedByUser.length) > 0
      ) {
        let parsedPetsPostedByUser = parsePetsPostedByUser(petsPostedByUser);
        return res.status(200).send(parsedPetsPostedByUser);
      } else {
        console.log(
          `Retornando petsPostedByUser con .length <= 0. Su length es ${
            petsPostedByUser === null || petsPostedByUser === void 0
              ? void 0
              : petsPostedByUser.length
          }`
        );
...
router.delete("/deletePet", jwtCheck, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _b, _c, _d;
    console.log(`En la ruta users/deletePet.`);
    console.log(
      `petId = ${
        (_b = req.query) === null || _b === void 0 ? void 0 : _b.petId
      }`
    );
    // console.log(req.body);
    console.log(
      `req.auth.sub = ${
        (_c = req.auth) === null || _c === void 0 ? void 0 : _c.sub
      }`
    );
    try {
...
router.get("/getMultipleUserInfo", jwtCheck, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _e, _f;
    console.log(`Entré a la ruta /users/getMultipleUserInfo`);
    console.log(
      `req.auth.sub = ${
        (_e = req.auth) === null || _e === void 0 ? void 0 : _e.sub
      }`
    );
    try {
      if ((_f = req.auth) === null || _f === void 0 ? void 0 : _f.sub) {
...
router.get("/points", jwtCheck, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _g;
...
router.get("/rankingGaveAdoption", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.post("/buyProducts", jwtCheck, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _h;
    console.log(`Estoy en /users/buyProducts.`);
    try {
      const { name, items, totalPoints, mail, direccion } = req.body;
      let userID = (_h = req.auth) === null || _h === void 0 ? void 0 : _h.sub;
...
router.post("/donatePoints", jwtCheck, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _j;
    ...
    try {
      ...
      const user = yield index_1.default.User.findOne({ where: { id: id } });
      const userToDonate = yield index_1.default.User.findOne({
        where: { id: idToDonate },
      });
