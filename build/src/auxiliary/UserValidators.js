...
exports.checkFullName = exports.checkThumbnail = exports.checkAditionalContactInfo = exports.checkEmail = exports.checkValidEmail = exports.isEmail = exports.checkCity = exports.checkUserName = exports.checkUserId = exports.validateNewUser = void 0;
...
function checkUserId(idFromReq) {
    if ((0, AnimalValidators_1.isStringBetween1And101CharsLong)(idFromReq)) {
        return idFromReq;
    }
...
function checkUserName(nameFromReq) {
    if ((0, AnimalValidators_1.isStringBetween1And101CharsLong)(nameFromReq)) {
        return nameFromReq;
    }
...
function checkCity(contactFromReq) {
    if ((0, AnimalValidators_1.isUndefinedOrNull)(contactFromReq) || (0, ReviewValidators_1.isEmptyString)(contactFromReq)) {
        return undefined;
    }
    if ((0, AnimalValidators_1.isStringBetween1And101CharsLong)(contactFromReq)) {
...
function checkAditionalContactInfo(aditionalContactInfoFromReq) {
    if ((0, AnimalValidators_1.isUndefinedOrNull)(aditionalContactInfoFromReq) ||
        (0, ReviewValidators_1.isEmptyString)(aditionalContactInfoFromReq)) {
        return undefined;
    }
    if ((0, AnimalValidators_1.isStringBetween1And101CharsLong)(aditionalContactInfoFromReq)) {
